...
2. Installing the makesqr Package

A. Change to the directory that contains the file setup.py and the subdirectory makesqr. 
...
3. Using the makesqr Package

The makesqr package is on your Python path. To import it into a Python script or session, 
execute:
